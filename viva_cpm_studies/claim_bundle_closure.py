...
# repo layout: <repo>/viva_cpm_studies/claim_bundle_closure.py ; workspace is a sibling
...
def write_closure(
    ...
    header = (
        "# GENERATED by viva_cpm_studies.claim_bundle_closure — do not hand-edit.\n"
        "# Derived closure verdict for the claim bundle (evaluated_by: code).\n"
        "# Regenerate: python viva_cpm_studies/claim_bundle_closure.py\n"
    )
